...
INPUT:
   ...
   -e, -engine string[]  search engine to query (shodan,shodan-idb,fofa,censys,quake,hunter,zoomeye,criminalip) (default shodan)
...
```console
echo jira | uncover -e shodan,censys,fofa,quake,hunter,zoomeye,criminalip
...
```console
uncover -shodan 'http.component:"Atlassian Jira"' -censys 'services.software.product=`Jira`' -fofa 'app="ATLASSIAN-JIRA"' -quake 'Jira' -hunter 'Jira' -zoomeye 'app:"Atlassian JIRA"' -criminalip 'Jira'
